<div class="flex bg-white py-6 px-3 rounded-md w-12/12 md:w-8/12 mx-auto">
    ...
    <div class="px-4 w-full">
        <div class="border border-gray-300 rounded-lg p-5 h-full">
            ...
            <p class="text-center mb-7">جهت دسترسی به پنل مدیریت یک ادمین ایجاد کنید.</p>
            ...
            <form wire:submit="save" class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    ...
                    <input wire:model="name" type="text" id="name"
                        ...
                        placeholder="نام کاربر ادمین را وارد کنید ..." required />
                </div>

                <div class="mb-5">
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900">آدرس ایمیل</label>
                    <input wire:model="email" type="email" id="email" autocomplete="false"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="آدرس ایمیل ادمین را وارد کنید ..." required />
                </div>

                <div class="mb-5">
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900">کلمه عبور</label>
                    <input wire:model="password" type="password" id="password" autocomplete="false"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="کلمه عبور ورود به پنل ادمین را وارد کنید ..." required />
                </div>
