    ...
    <div class="px-4 w-full">
        <div class="border border-gray-300 rounded-lg p-5 h-full">
            ...
            <form wire:submit="save" class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    <label for="app_name" class="block mb-2 text-sm font-medium text-gray-900">نام وبسایت</label>
                    <input wire:model="app_name" type="app_name" id="app_name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="نام محصول را وارد کنید..." required />
                </div>

                <div class="mb-5">
                    <label for="app_url" class="block mb-2 text-sm font-medium text-gray-900">آدرس وبسایت (نیازی به
                        ویرایش ندارد مگر درصورت نیاز)</label>
                    <input wire:model="app_url" type="app_url" id="app_url"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="آدرس وبسایت" required />
                </div>
