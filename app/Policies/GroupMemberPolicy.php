...
class GroupMemberPolicy
{
     ...
     */
    public function view(Admin $user, GroupMember $groupmember): bool
    {
     ...
     */
    public function update(Admin $user, GroupMember $groupmember): bool
    {
     ...
     */
    public function delete(Admin $user, GroupMember $groupmember): bool
    {
     ...
     */
    public function restore(Admin $user, GroupMember $groupmember): bool
    {
     ...
     */
    public function replicate(Admin $user, GroupMember $groupmember): bool
    {
     ...
     */
    public function forceDelete(Admin $user, GroupMember $groupmember): bool
    {
